                    ...
                    <div className="content">
                        ...
                        {isVolunteer ? (<>
                            ...
                            {event.volunteersNumber > 0 ? (
                                <button className="ext-card-button3" id="submit"  onClick={handleSubmitClick}>Submit</button>
                            ) : (
                                ...
                                <div className="custom-radio">
                                    {prices.map((price, index) => (
                                        <div className="horizontal" key={index}>
                                            {hasMorePrices ? (
                                                <>
                                                    <input value={price} name="hopping" type="radio" className="ext-card-radio"
                                                        id={`radio${index}`} onChange={() => handleRadioChange(index)} checked={index === selectedPriceIndex}/>
                                                    <div className="price-and-type">Race type: {types[index]}. Price: {price}.</div>
                                                </>
                                            ) : null}
                                        </div>
                                    ))}
